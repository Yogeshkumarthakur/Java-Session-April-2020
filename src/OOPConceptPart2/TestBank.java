...
public class TestBank {
	...
	public static void main(String[] args) {
		...
		System.out.println(USBank.min_bal); // this car has been called from US bank interface and it is sttic in nature so called by interface name 
		//this var is static and final in nature you cannot change the value here
		
		// remember we can not create the object of interface
